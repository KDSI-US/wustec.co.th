...
class ControllerExtensionModuleNewsletters extends Controller
{
	...
	public function index()
	{
		...
		$this->model_extension_module_newsletter->createNewsletter();
		...
		$this->load->model('extension/module/newsletter');
		$result = $this->model_extension_module_newsletter->getNewsLetter();
		$data['newsltr'] = array();
	...
	public function uninstall()
	{
		...
		$this->model_extension_module_newsletter->dropNewsletter();
	}
