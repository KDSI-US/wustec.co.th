...
class ControllerExtensionModuleBlogger extends Controller
{
	...
	public function index()
	{
		...
		$this->load->model('extension/module/blogger');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				$module_id = $this->model_extension_module_blogger->addModule('blogger', $this->request->post);
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$results = $this->model_extension_module_blogger->getBlogsByModule($this->request->get['module_id']);
		}

		if ($results) {
			foreach ($results as $result) {
				$total_comments = $this->model_extension_module_blogger->getTotalBlogComments($result['blogger_id']);
	...
	public function install()
	{
		...
		$this->model_extension_module_blogger->createBlogs();
	}
	...
	public function uninstall()
	{
		...
		$this->model_extension_module_blogger->dropBlogs();
	}
	...
	public function add()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_module_blogger->addBlog($this->request->post, $this->request->post['module_id']);
	...
	public function edit()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_module_blogger->editBlog($this->request->get['blogger_id'], $this->request->post);
	...
	public function delete()
	{
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blogger_id) {
				$this->model_extension_module_blogger->deleteBlog($blogger_id);
			}
			...
			$this->model_extension_module_blogger->deleteBlog($this->request->get['blogger_id']);
	...
	public function getForm()
	{
		...
		if (isset($this->request->get['blogger_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$blogger_info = $this->model_extension_module_blogger->getBlog($this->request->get['blogger_id']);
		}
		...
		if (isset($this->request->post['blogger_description'])) {
			...
			$data['blogger_description'] = $this->model_extension_module_blogger->getBlogDescriptions($this->request->get['blogger_id']);
		} else {
	...
	private function getList()
	{
		...
		$blogger_total = $this->model_extension_module_blogger->getTotalBlogs();

		$results = $this->model_extension_module_blogger->getBlogs($filter_data);
		...
		foreach ($results as $result) {
			$module_info = $this->model_extension_module_blogger->getModule($result['module_id']);
	...
	public function getComments()
	{
		...
		$blog_info = $this->model_extension_module_blogger->getBlog($this->request->get['blogger_id']);

		$blog_title = $this->model_extension_module_blogger->getBlogTitle($this->request->get['blogger_id']);
		...
		$blog_comment_total = $this->model_extension_module_blogger->getTotalBlogComments($this->request->get['blogger_id']);

		$results = $this->model_extension_module_blogger->getBlogComments($this->request->get['blogger_id'], $filter_data);
	...
	public function approve_comment()
	{
		...
		$this->model_extension_module_blogger->approveComment($this->request->get['blogger_comment_id']);
	...
	public function disapprove_comment()
	{
		...
		$this->model_extension_module_blogger->disapproveComment($this->request->get['blogger_comment_id']);
	...
	public function delete_comment()
	{
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blogger_comment_id) {
				$this->model_extension_module_blogger->deleteBlogComment($blogger_comment_id);
			}
	...
	protected function viewComment()
	{
		...
		$comment_info = $this->model_extension_module_blogger->getBlogComment($this->request->get['blogger_comment_id']);

		$comment_descriptions = $this->model_extension_module_blogger->getBlogCommentDescriptions($this->request->get['blogger_comment_id']);
