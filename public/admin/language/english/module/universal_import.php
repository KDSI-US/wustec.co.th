...
$_['text_type_seo_redirect'] = 'SEO redirections';
...
$_['entry_image_number'] = 'Max number of images';
$_['entry_image_number_i'] = 'How many images to get? Leave empty for unlimited';
$_['entry_image_number_ph'] = '5';
...
$_['entry_delete'] = 'Mode';
$_['entry_delete_notempty'] = 'Empty file';
$_['entry_delete_notempty_'] = 'Delete items even if file is empty';
$_['entry_delete_notempty_1'] = 'Do not delete items if file is empty';
...
$_['text_delete_zero_opt'] = 'Set quantity to zero (also for options)';
...
$_['text_delete_disable_zero'] = 'Disable and set qty to zero';
$_['text_delete_disable_zero_opt'] = 'Disable and set qty to zero (also for options)';
...
$_['entry_attribute_generate'] = 'Generate attributes from';
$_['entry_attribute_generate_i'] = 'Check these options to automatically generate the product attributes based on the following fields';
...
$_['entry_disable_update'] = 'Disable field on update';
$_['entry_disable_update_empty'] = 'Disable if empty';
$_['tab_disable_update'] = 'Disable field on update';
$_['info_disable_update'] = 'This is allowing to set some fields that won\'t be updated in case of using update preserve mode, for example if you have all your fields configured so a new product is inserted with all data and you want that price is not anymore updated next time you run the import profile, then this option will allow you to remove price field from update preserve so there is no need to do that in 2 separate profiles.';
...
$_['entry_category_code_i'] = 'Set unique code to identify your category';
...
$_['entry_exclude_option_value'] = 'Exclude option value';
$_['entry_exclude_option_value_i'] = 'Somes feeds come with an option like Standard or Unique size that can be useful to remove to not add unnecessary option to the product';
...
$_['entry_insert_method_add'] = 'Add - add new values';
...
$_['xfn_jsonencode'] = '<i class="fa fa-fw">&#xf121;</i> Encode JSON';
$_['xfn_jsondecode'] = '<i class="fa fa-fw">&#xf121;</i> Decode JSON';
...
$_['xfn_date'] = '<i class="fa fa-fw">&#xf073;</i> Date generator';
$_['xfn_date_i'] = 'Generate a date using keywords like today, tomorrow, +1 month';
$_['text_alter_date'] = 'Date alteration';
$_['text_alter_date_i'] = 'Use keywords like tomorrow, +15 days, +6 month, +1 year, check php documentation for function strtotime() to see all available keywords, let empty to not change';
...
<br/><b>Product values (only for update):</b><br/>
[nameX] Item name (X = language id)<br/>
[manufacturer] Manufacturer<br/>
[category] Category - [category_id] Category ID<br/>
[product_id] Product ID<br/>
[quantity] Quantity<br/>
[model] model - [ean] EAN - [sku] SKU<br/>
';
...
$_['text_init_date'] = 'Initial date';
$_['text_init_date_i'] = 'The source date to work on, let empty for current date';
$_['text_date_format'] = 'Format';
$_['text_date_format_i'] = 'Let empty to convert to sql date format which is convenient for opencart dates, to convert to other format see available formatting for date() function of PHP, for example d-m-Y';
...
$_['entry_import_batch'] = 'Import label';
...
$_['entry_export_exclude_i'] = 'Exclude mode';
...
$_['filter_ean'] = 'EAN';
$_['filter_ean_i'] = 'Set various using | tube sign';
$_['filter_tag'] = 'Tag';
...
$_['text_log_min'] = 'Minimal - Log only summary of global process and errors';
...
$_['text_attr_mode_default']		= '3 parts - Group:Name:Value';
$_['text_attr_mode_2']		= '2 parts - Name:Value';
$_['text_attr_mode_1']		= '1 part - Value (auto-detect name from column)';
$_['text_download_value']		= 'Download value';
$_['info_recurring']		= '
<h4>Recurring profiles</h4>
<p>Can be formatted in various ways:</p>
<table class="table">
  <tr><td><b>customer_group:recurring_profile</b></td><td>The customer group is specified so import the recurring profile only to this group</td></tr>
  <tr><td><b>recurring_profile</b></td><td>If no customer group assigned the recurring profile will be assigned to all groups</td></tr>
</table>
<h4>Auto-detection</h4>
<p>Customer group will be detected either by customer group ID or group name.<br/>Recurring profile will be detected either by recurring profile ID or name.</p>';
...
';
$_['info_column_mapping_title'] = 'Column mapping';
$_['info_column_mapping'] = '<h4>How column mapping works?</h4>
<p>In step 3 you can set which data from your import file you want to import into your opencart, it is not mandatory to assign absolutly all data from your import file, only assign the data that you need and is required in your case.</p>
<p>Note that the structure of the tabs is exactly the same than what you see when editing an item in opencart, so it is easy to find where to set your date, for example to set the price just go into Data > Price and choose which column of your file should be assigned for the price.</p>
<h4>Preserve mode</h4>
<p>If you have selected in <b>Step 2 > Existing item action > Update - preserve</b> the the non-assigned fields will be preserved during import, if you set some default value where it is possible this default value won\'t be inserted, it will be only in case it is new product, but if updating it then it is ignored. You can force a default value by choosing explicitly <b>Set default value</b>.</p>
<h4>Replace mode</h4>
<p>If you have selected in <b>Step 2 > Existing item action > Update - replace</b> the whole item is resetted, the non-assigned fields will be resetted during import and if you have set default value it will be inserted.</p>
<h4>Altering the import data</h4>
<p>Do you need to change the data you are about to import? for example to apply percentage to increase a price, change some texts by adding, removing, or replacing sentences, etc. Then you can use Extra Functions tab for this, there is very powerful features that make possible to do almost everything you might need on your data.</p>
';
$_['info_general'] = '<h4>General</h4>
<p>Here is the data like name, description, title, etc.</p>
<p>For each of these fields you can set the data in all of your languages.</p>
<h4>SEO keyword</h4>
<p>On OC3 or if you have <a href="http://www.opencart.com/index.php?route=extension/extension/info&extension_id=9486" target="blank">Complete SEO Package</a> installed you will haved the Keyword field in this tab (instead of Data for earlier versions), if you don\'t have a defined value in your import file then it is generally recommended to do the following:
<ul>
  <li>- Go to Step 2 > Extra fields</li>
  <li>- Add an extra field named for example <b>seoKeyword</b> (do various with each name if you have multiple languages)</li>
  <li>- Assign this extra field in Step 3 > General > Keyword</li>
  <li>- Go to Step 3 > Extra function</li>
  <li>- Add function <b>Format for URL</b> from the item name and save into your extra field seoKeyword</li>
</ul>
</p>
<h4>What if I have separate files for each languages?</h4>
<p>If you cannot import all languages at once then you will need to do 2 import profiles, in first profile set all the data to import in the product and the main language, let blank the fields for the other language, then in second profile make sure to set Step 2 > Existing item action > Update - preserve, and then let blank the main language, and set the other language field, so you will be able to import your second language without overwriting main one.</p>
';
$_['info_categories_title'] = 'Categories';
$_['info_categories'] = '<h4>Import categories</h4>
<p>Categories will be detected either by ID, code, or name.<br/>The category code is added by universal import to make possible to import categories from multiple suppliers in case they use some ID instead of name.<br/>The categories will be auto created in case they do not exist (you can change that in step 2).</p>
<h4>Subcategories</h4>
<p><b>I have subcategory in separate column</b><br/>In this case choose your main category and click on Add button, choose Add subcategory, and set the field containing your subcategory, you can repeat the process for as many subcategory levels you have.</p>
<p><b>I have subcategory in same column</b><br/>In this case no need to add new subcategory, just select your column containing your categories, and make sure that you have selected correct Subcategory separator in Step 2 > Category settings.</p>
<h4>I don\'t want to create the categories from import file but rather import products in my actual opencart categories</h4>
<p>For this there is dedicated powerful function, set the category field here and then go to Extra function > Column binding, there you will be able to to choose in which of your existing categories will fall the products.</p>
';
$_['info_image_title'] = 'Images';
$_['info_image'] = '<h4>Import images</h4>
<p><b>I have only one column containing main image and additional images</b><br/>Assign this column in both main image and additional images, the module will auto detect the first image and remove it from additional ones. Also make sure make sure that you have selected correct Multiple value separator in Step 2 > Common settings.</p>
<p><b>I have additional images in separate columns</b><br/>For images in separate columns simply click on Add column button to assign as many image fields you have.</p>
<p><b>I have multiple images in same column</b><br/>In this case no need to add new column, just select your column containing your images, and make sure that you have selected correct Multiple value separator in Step 2 > Common settings, if you\'re in XML import then use Step 3 > Extra function > Multiple values separator.</p>
<p><b>In XML I have an array of images appearing in preview</b><br/>Just select your column containing this image array in both main image and additional images, no need to set each additional image like images/0/image/1, images/0/image/2, just set images/0/image and the module will handle all that automatically.</p>
';
$_['info_remove'] = '<h4>Remove or disable items</h4>
<p>In this section you can choose to automatically delete or disable some items based on settings to choose exactly what you need to remove</p>
<p>In all cases you have possibility to completly delete the item (ie: removing it from database), or just set its status to disabled, or set quantity to 0.</p>
<h4>Use import labels!</h4>
<p>If you have multiple suppliers or you have some products that you enter manually then you will generally need to use import label to handle that correctly without deleting unwanted data, make sure that each of your import profiles can be identified by an import label that you can set in Step 4.</p>
<h4>Case examples</h4>
<h5>I want to delete all items before import</h5>
<p>Choose "For all items before import" and do not change the other settings.</p>
<h5>I want to delete all items that have been imported by the module but not the ones that I have created manually</h5>
<p>Choose "For all items before import" and set Import label to "Existing import label".</p>
<h5>I want to delete all items that have been imported by the module but but only from specific profile</h5>
<p>Choose "For all items before import" and set Import label to the one you want to delete.</p>
<h5>I have import file from my supplier which does not contains anymore the discoutinued products, so I need to disable these only</h5>
<p>Choose "For non upddated items only" and set Import label to the one you want to delete.</p>
';
$_['info_extra'] = '<h4>Extra fields</h4>
<p>Extra fields can be used to store new data that you will get when manipulating your import data with Step 3 > Extra functions, for example if you have price field that you need to increase by 20% then you can directly apply the function percentage to add the 20%, but the original field is modified and if you needed to import both original data and added percentage data then you have to use extra field.<br/><br/>To do so just set extra field named "price20Percent" and when you set your percentage function choose to save the result into your extra field instead of original field, so now you can import both original and altered field.</p>
';
$_['info_category_data_title'] = 'Category data';
$_['info_category_data'] = '<h4>Category data</h4>
<h5>Category code</h5>
<p>This code is added by Universal Import, it allows to identify your category by unique code just like you could do it with the product model, it can be useful to use it when you have multiple suppliers which are referencing to the category by its ID instead of name which make impossible to import the categories at same time of the product, and you may need to not import the categories by ID to not conflict with existing categories or other suppliers.<br/><br/>In this case use the category code to set unique code to your category by using extra function prepend to add for example "supplier1-" before the category ID and then put this value into the category code, this way your are now able to identify your category by code instead of real ID.</p>
<h5>Parent</h5>
<p>The parent of the category, empty or 0 means no parent (i.e. this category is at root).</p>
<h5>Children</h5>
<p>Children of current category</p>
';
