(function (modules) {
				...
				API.prototype[name.toLowerCase()] =
					function (text, options) {
						...
						return api._errorHandler.wrapBarcodeCall(function () {
							...
							newOptions = (0, _optionsFromStrings2.default)(
								newOptions
							);
		...
		var CODE39 = (function (_Barcode) {
			...
			function CODE39(data, options) {
				...
				return _possibleConstructorReturn(
					this,
					(CODE39.__proto__ || Object.getPrototypeOf(CODE39)).call(
						this,
						data,
						options
					)
	...
	/***/ function (module, exports, __webpack_require__) {
		...
		var CODE128 = (function (_Barcode) {
			...
			function CODE128(data, options) {
				...
				var _this = _possibleConstructorReturn(
					this,
					(CODE128.__proto__ || Object.getPrototypeOf(CODE128)).call(
						this,
						data.substring(1),
						options
					)
						...
						value: function encode() {
							...
							return {
								...
								data:
									...
									// Add the checksum
									CODE128.getBar(
										(encodingResult.checksum + startIndex) %
											_constants.MODULO
									) +
									// Add the end bits
	...
	/***/ function (module, exports, __webpack_require__) {
		...
		var matchSetALength = function matchSetALength(string) {
			return string.match(new RegExp("^" + _constants.A_CHARS + "*"))[0]
				.length;
		};
		var matchSetBLength = function matchSetBLength(string) {
			return string.match(new RegExp("^" + _constants.B_CHARS + "*"))[0]
				.length;
		};
		...
		exports.default = function (string) {
			...
			if (cLength >= 2) {
				...
				var isA = matchSetALength(string) > matchSetBLength(string);
				newString =
					(isA ? _constants.A_START_CHAR : _constants.B_START_CHAR) +
					autoSelectFromAB(string, isA);
			}
		...
		var CODE128A = (function (_CODE) {
			...
			function CODE128A(string, options) {
				...
				return _possibleConstructorReturn(
					this,
					(
						CODE128A.__proto__ || Object.getPrototypeOf(CODE128A)
			...
			_createClass(CODE128A, [
				{
					key: "valid",
					value: function valid() {
						return new RegExp("^" + _constants.A_CHARS + "+$").test(
							this.data
						);
					},
				},
		...
		var CODE128B = (function (_CODE) {
			...
			function CODE128B(string, options) {
				...
				return _possibleConstructorReturn(
					this,
					(
						CODE128B.__proto__ || Object.getPrototypeOf(CODE128B)
			...
			_createClass(CODE128B, [
				{
					key: "valid",
					value: function valid() {
						return new RegExp("^" + _constants.B_CHARS + "+$").test(
							this.data
						);
					},
				},
		...
		var CODE128C = (function (_CODE) {
			...
			function CODE128C(string, options) {
				...
				return _possibleConstructorReturn(
					this,
					(
						CODE128C.__proto__ || Object.getPrototypeOf(CODE128C)
			...
			_createClass(CODE128C, [
				{
					key: "valid",
					value: function valid() {
						return new RegExp("^" + _constants.C_CHARS + "+$").test(
							this.data
						);
					},
				},
	...
	/***/ function (module, exports, __webpack_require__) {
		...
		var EAN = (function (_Barcode) {
			...
			function EAN(data, options) {
				...
				_this.guardHeight =
					options.height + _this.fontSize / 2 + options.textMargin;
				return _this;
			}
			...
			_createClass(EAN2, [
				...
				},
				{
					...
					value: function encode() {
						...
						var structure =
							_constants.EAN2_STRUCTURE[parseInt(this.data) % 4];
						return {
	...
	/***/ function (module, exports, __webpack_require__) {
		...
		var MSI1010 = (function (_MSI) {
			...
			function MSI1010(data, options) {
				...
				return _possibleConstructorReturn(
					this,
					(MSI1010.__proto__ || Object.getPrototypeOf(MSI1010)).call(
						this,
						data,
						options
					)
	...
	/***/ function (module, exports, __webpack_require__) {
		...
		var MSI1110 = (function (_MSI) {
			...
			function MSI1110(data, options) {
				...
				return _possibleConstructorReturn(
					this,
					(MSI1110.__proto__ || Object.getPrototypeOf(MSI1110)).call(
						this,
						data,
						options
					)
	...
	/***/ function (module, exports, __webpack_require__) {
		...
		var codabar = (function (_Barcode) {
			...
			function codabar(data, options) {
				...
				var _this = _possibleConstructorReturn(
					this,
					(codabar.__proto__ || Object.getPrototypeOf(codabar)).call(
						this,
						data.toUpperCase(),
						options
					)
		...
		function getOptionsFromElement(element) {
			...
			for (var property in _defaults2.default) {
				if (_defaults2.default.hasOwnProperty(property)) {
					...
					// data-*
					if (
						element.hasAttribute("data-" + property.toLowerCase())
					) {
						options[property] = element.getAttribute(
			...
			_createClass(CanvasRenderer, [
				...
				},
				{
					...
					value: function prepareCanvas() {
						...
						var totalWidth = (0, _shared.getTotalWidthOfEncodings)(
							this.encodings
						);
						var maxHeight = (0,
						_shared.getMaximumHeightOfEncodings)(this.encodings);
