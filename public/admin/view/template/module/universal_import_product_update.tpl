          ...
          <div class="row" style="padding-bottom:15px">
            ...
            <div class="col-md-9">
              <select name="discount_insert_type" class="form-control">
                ...
                <option value="<?php echo $insert_type; ?>" <?php if (isset($profile['discount_insert_type']) && $profile['discount_insert_type'] == $insert_type) echo 'selected="selected"'; ?>><?php echo $_language->get('entry_insert_method_'.$insert_type); ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
