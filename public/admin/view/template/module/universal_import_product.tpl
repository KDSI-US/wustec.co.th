  ...
  <div class="tab-content alternateColors">
        ...
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            ...
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_column_mapping_title'); ?></span></a></li>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('tab_general'); ?></span></a></li>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_column_mapping'); ?></div>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_general'); ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_help'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_categories_title'); ?></span></a></li>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_filter_title'); ?></span></a></li>
              <?php if (in_array($filetype, array('xml', 'json'))) { ?>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_downloads_xml_title'); ?></span></a></li>
              <?php } ?>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_categories'); ?></div>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_filter_xml'); ?></div>
              <?php if (in_array($filetype, array('xml', 'json'))) { ?>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_downloads_xml'); ?></div>
              <?php } ?>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_help'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_attributes_title'); ?></span></a></li>
              <?php if (in_array($filetype, array('xml', 'json'))) { ?>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_attributes_xml_title'); ?></span></a></li>
              <?php } ?>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_attributes'); ?></div>
              <?php if (in_array($filetype, array('xml', 'json'))) { ?>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_attributes_xml'); ?></div>
              <?php } ?>
            </div>
          </div>
        </div>
      ...
      <div class="form-group" style="margin-bottom:0">
        ...
        <div class="col-md-4">
          <select name="attr_mode" class="form-control">
            ...
            <option value="2" <?php if (isset($profile['attr_mode']) && $profile['attr_mode'] == '2') echo 'selected="selected"'; ?>><?php echo $_language->get('text_attr_mode_2'); ?></option>
    ...
    <div class="tab-pane" id="tab-option">
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_help'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_options_title'); ?></span></a></li>
              <?php if (in_array($filetype, array('xml', 'json'))) { ?>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_options_xml_title'); ?></span></a></li>
              <?php } else { ?>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_options_advanced_title'); ?></span></a></li>
              <?php } ?>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_options'); ?></div>
              <?php if (in_array($filetype, array('xml', 'json'))) { ?>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_options_xml'); ?></div>
              <?php } else { ?>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_options_advanced'); ?></div>
              <?php } ?>
            </div>
          </div>
        </div>
      ...
      <div class="form-group" style="margin-bottom:0">
        ...
        <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $_language->get('entry_exclude_option_value_i'); ?>"><?php echo $_language->get('entry_exclude_option_value'); ?></span></label>
        <div class="col-md-4">
          <input type="text" name="exclude_option_value" class="form-control" value="<?php echo isset($profile['exclude_option_value']) ? $profile['exclude_option_value'] : ''; ?>" placeholder="Standart|Unique Size"/>
        </div>
      </div>
      <hr class="dotted"/>
      ...
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_help'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('tab_recurring'); ?></span></a></li>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_recurring'); ?></div>
            </div>
          </div>
        </div>
      </div>
      
      <?php dataField('product_recurring', $_language->get('entry_recurring'), $columns, $profile, $_language, false, false, true); ?>
    </div>
    ...
    <div class="tab-pane" id="tab-discount">
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_discount_title'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_options_title'); ?></span></a></li>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_discount_advanced_title'); ?></span></a></li>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_discount'); ?></div>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_special_advanced'); ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_discount_title'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_special_title'); ?></span></a></li>
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_special_advanced_title'); ?></span></a></li>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_special'); ?></div>
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_special_advanced'); ?></div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-offset-2">
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            <i class="icon fa fa-info-circle fa-2x pull-left" title="<?php echo $_language->get('info_help'); ?>"></i>
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_image_title'); ?></span></a></li>
            </ul>
          </header>
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_image'); ?></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="tab-pane" id="tab-functions">
      ...
      <ul class="nav nav-pills nav-stacked col-md-2">
        ...
        <?php if (isset($profile['item_exists']) && in_array($profile['item_exists'], array('soft_update', 'update_option'))) { ?>
        <li><a href="#tab-extra-func-5" data-toggle="pill"><?php echo $_language->get('tab_disable_update'); ?></a></li>
        <?php } ?>
      ...
      <div class="tab-content col-md-10" style="min-height:400px;padding-bottom:120px">
        ...
        <?php if (isset($profile['item_exists']) && in_array($profile['item_exists'], array('soft_update', 'update_option'))) { ?>
        <div class="tab-pane" id="tab-extra-func-5"><?php extraDisableUpdate($columns, $profile, $_language, $languages, get_defined_vars()); ?></div>
        <?php } ?>
