  ...
  <div class="tab-content alternateColors">
    <div class="tab-pane active" id="tab-general">
      ...
      <div class="form-group" style="margin-bottom:0">
        ...
        <div class="col-md-4">
          <input type="radio" class="switch" name="pwd_hash" value="0" data-label="<?php echo $_language->get('text_pwd_clear'); ?>" <?php if (empty($profile['pwd_hash'])) echo 'checked'; ?>/>
          <input type="radio" class="switch" name="pwd_hash" value="1" data-label="<?php echo $_language->get('text_pwd_hash'); ?>" <?php if (!empty($profile['pwd_hash'])) echo 'checked'; ?>/>
        </div>
      </div>
      <hr class="dotted"/>
