...
?>
  ...
  <div class="tab-content alternateColors">
    ...
    <div class="tab-pane" id="tab-data">
        ...
        <div class="gkdwidget gkdwidget-color-blueLight clearfix">
          <header role="heading">
            ...
            <ul class="nav nav-tabs pull-left in">
              <li><a data-toggle="tab" href="#gkhelps3<?php echo $gkhtab++; ?>"><span class="hidden-mobile hidden-tablet"><?php echo $_language->get('info_category_data_title'); ?></span></a></li>
          ...
          <div class="gkdwidget-container" style="display:none">
            <div class="tab-content">
              <div class="tab-pane" id="gkhelps3<?php echo $gkhdiv++; ?>"><?php echo $_language->get('info_category_data'); ?></div>
      ...
      <?php dataField('code', $_language->get('entry_category_code'), $columns, $profile, $_language); ?>
      ...
      <?php /* dataField('children_image', $_language->get('entry_children_image'), $columns, $profile, $_language, false, $categories, true); */ ?>
      ...
      <?php dataField('category_filter', $_language->get('entry_filter'), $columns, $profile, $_language, false, false, true); ?>
