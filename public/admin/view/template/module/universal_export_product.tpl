    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="form-group">
          ...
          <span class="input-group-addon" data-toggle="tooltip" title="<?php echo $_language->get('entry_export_exclude_i'); ?>"><input type="checkbox" name="filter_category_exclude" value="1" <?php if (!empty($profile['filter_category_exclude'])) echo 'checked'; ?>/></span>
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="form-group">
          ...
          <span class="input-group-addon" data-toggle="tooltip" title="<?php echo $_language->get('entry_export_exclude_i'); ?>"><input type="checkbox" name="filter_model_exclude" value="1" <?php if (!empty($profile['filter_model_exclude'])) echo 'checked'; ?>/></span>
      ...
      <div class="col-sm-4">
        <div class="form-group">
          <?php fieldLabel('filter_ean', $_language); ?>
          <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-fw fa-barcode"></i></span>
          <input type="text" class="form-control" name="filter_ean" value="<?php echo isset($profile['filter_ean']) ? $profile['filter_ean'] : ''; ?>" placeholder=""/>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
