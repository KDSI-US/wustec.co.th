...
class ControllerOcrestapiExtensionModuleAmazonLogin extends OcrestapiController {
    public function index() {
        ...
        if ($this->config->get('payment_amazon_login_pay_status') && $this->config->get('module_amazon_login_status') && !$this->customer->isLogged() && !empty($this->request->server['HTTPS'])) {
            ...
            $data['return_url'] = html_entity_decode($this->url->link('ocrestapi/extension/module/amazon_login/login', '', true), ENT_COMPAT, "UTF-8");
