...
class ControllerOcrestapiAccountOrder extends OcrestapiController {
	public function index() {
		$this->checkPlugin();
		
		$language=$this->load->language('account/order');
		...
		$order_total = $this->model_account_order->getTotalOrders();
				 // echo (int)$this->customer->getId(); die;
	...
	public function info() {
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				if ($product_info) {
					$reorder = $this->url->link('ocrestapi/account/order/reorder', 'order_id=' . $order_id . '&order_product_id=' . $product['order_product_id'], true);
				} else {
					$reorder = '';
				}
			...
			$this->json['errors']['no_order_data']=$this->language->get('text_empty');
			return $this->sendResponse();
		}
	}
		...
		if ($order_info) {
			...
			if ($order_product_info) {
				...
				if ($product_info) {
					...
					$data['success'] = $this->language->get('text_cart_success');
				} else {
