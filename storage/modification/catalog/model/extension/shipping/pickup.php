	...
	function getQuote($address) {
		...
		if ($status) {
			...
			$quote_data['pickup'] = array(
				...
				'pickup_instruction' => nl2br($this->config->get('shipping_pickup_instruction')),
				'pickup_instruction_text_color' => $this->config->get('shipping_pickup_instruction_text_color')
			);
