...
class ControllerAccountWishList extends Controller {
	...
	public function toggle()
	{
		...
		if (isset($this->request->post['product_id'])) {
			...
			if ($product_info) {
				$wishlist_link = $this->url->link('account/wishlist');
				...
				if ($this->customer->isLogged()) {
					...
					if (!in_array($product_id, array_column($wishlist, 'product_id'))) {						
						...
						$text_success = $this->language->get('text_remove_success');
					}
					$json['success'] = sprintf($text_success, $this->url->link('product/product', 'product_id='.$product_id), $product_info['name'], $wishlist_link);
					...
					$json['success'] = sprintf($this->language->get('text_login'), $this->url->link('account/login', '', true), $this->url->link('account/register', '', true), $this->url->link('product/product', 'product_id='.$product_id), $product_info['name'], $wishlist_link);						
