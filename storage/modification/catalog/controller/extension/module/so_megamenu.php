...
class ControllerExtensionModuleSomegamenu extends Controller {
    public function index($setting) {
        ...
        if (!$setting) {
            ...
            $setting['cache_time'] = "3600";
            $setting['orientation'] = "0";
            $setting['search_bar'] = 0;
            $setting['navigation_text'][0] = "";
            $setting['full_width'] = "1";
            $setting['home_item'] = "disabled";
            $setting['home_text'][0] = "";
            $setting['show_itemver'] = "5";
            $setting['animation'] = "fade";
            $setting['animation_time'] = "3000";
            $setting['disp_title_module'] = "1";
        }
	...
	public function readData($setting) {
        ...
        /* Set css and js files on header.twig */
        ...
        /* Get Module ID from DB by module name */
        $config_megamenu = $this->config->get('config_megamenu');
        $setting['moduleid'] = $this->model_extension_module_so_megamenu->getModueID($config_megamenu);
