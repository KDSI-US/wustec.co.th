...
class ControllerExtensionsignup extends Controller {
	public function index(){
		$this->load->language('extension/signup');
		...
		if ($this->config->get('config_account_id')) {
			...
			return $this->load->view('default/template/extension/signup', $data);
		
	}
	
	public function register() {
		$json =array();
		$this->language->load('extension/signup');
		$this->language->load('account/success');
		$this->load->model('account/customer');
		$this->load->model('catalog/information');
		$this->load->model('extension/signup');
		...
		if(!$json) {
			...
			$this->model_extension_signup->addCustomer($this->request->post);
			$json['success'] = true;
