...
class ControllerProductManufacturer extends Controller {
	public function index() {
            ...
            if ($login_required['status_manufacturer']) {
                $redirect = true;
                ...
                if ($redirect) {
                    $this->session->data['redirect'] = $this->url->link('product/manufacturer', '', true);
		...
		if ($approval_required['status_manufacturer']) {
			$redirect = true;
			if (isset($this->request->get['route'])) {
				$route = $this->request->get['route'];
			} else {
	...
	public function info() {
            ...
            if ($login_required['status_manufacturer']) {
                ...
                if ($redirect) {
                    ...
                    $this->session->data['redirect'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer_id , true);
                    $this->response->redirect($this->url->link('account/login', '', true));
                }
            }
		...
		if ($manufacturer_info) {
			...
			$data['limit'] = $limit;
                ...
                $filter_galleria = array(
                    'source' => 'manufacturer',
                    'source_id'  => $this->request->get['manufacturer_id']
                );
