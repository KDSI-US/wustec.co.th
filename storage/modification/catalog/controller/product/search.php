		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			foreach ($results as $result) {
					...
					foreach ($option['product_option_value'] as $option_value) {
						...
						if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
							...
							$product_option_value_data[] = array(
								...
								'option_image'	          => $this->model_tool_image->resize($option_value['option_image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_thumb_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_thumb_height')),
				...
				$data['products'][] = array(
					...
					'thumb_swap'  	=> $this->model_tool_image->resize($images, $this->config->get('theme_' . $this->config->get('config_theme') . '_image_thumb_width'), 
