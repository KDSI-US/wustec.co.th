...
class ControllerStartupStartup extends Controller {
	public function index() {
		...
		$this->config->set('config_language_id', $languages[$code]['language_id']);	
            ...
            if (is_array($meta_title) && !empty($meta_title[$this->config->get('config_language_id')])) {
                $this->config->set('config_meta_title', $meta_title[$this->config->get('config_language_id')]);
            }
            if (is_array($meta_description) && !empty($meta_description[$this->config->get('config_language_id')])) {
                $this->config->set('config_meta_description', $meta_description[$this->config->get('config_language_id')]);
            }
            if (is_array($meta_keywords) && !empty($meta_keywords[$this->config->get('config_language_id')])) {
                $this->config->set('config_meta_keyword', $meta_keywords[$this->config->get('config_language_id')]);
            }
