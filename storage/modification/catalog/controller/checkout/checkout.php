...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
		...
		if($this->config->get('mpcheckout_status')) {			
            ...
            if ($login_required['status_checkout']) {
                $redirect = true;
      ...
      if ($approval_required['status_checkout']) {
        $redirect = true;
        if (isset($this->request->get['route'])) {
          $route = $this->request->get['route'];
        } else {
		...
		$this->load->language('checkout/checkout');
			...
			$data['modulestatus'] = $this->config->get('registermanager_status');
			$data['chregstatus'] = $this->config->get('registermanager_checkregister');
			$data['gueststatus'] = $this->config->get('registermanager_guestregister');
