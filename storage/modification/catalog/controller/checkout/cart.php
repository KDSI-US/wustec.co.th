...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($approval_required['status_cart']) {
			$redirect = true;
			if (isset($this->request->get['route'])) {
				$route = $this->request->get['route'];
			} else {
	...
	public function add() {
		...
		if($this->config->get('mpplan_status')) {
			if(!empty($this->request->post['mpplan_id']) && $this->request->post['product_id'] == $this->config->get('mpplan_product_id')) {
				$option['mpplan_id'] = $this->request->post['mpplan_id'];
			}
		}
		/* MP Membership Ends */
