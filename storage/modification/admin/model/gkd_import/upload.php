...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => DIR_CACHE.'universal_import/',
            'upload_url' => HTTP_CATALOG.'system/cache/',
            ...
            'accept_file_types' => '/\.(txt|tsv|csv|xls|xlsx|ods|xml|json|zip|gz|bz2|sql)$/i',
