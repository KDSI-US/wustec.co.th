...
require_once (DIR_APPLICATION . 'model' . DIRECTORY_SEPARATOR . 'extension' . DIRECTORY_SEPARATOR . 'module' . DIRECTORY_SEPARATOR . 'so_simple_data' . DIRECTORY_SEPARATOR . 'so_page_builder.php');
