...
class ModelLocalisationOrderStatus extends Model {
    ...
    if ($this->config->get('module_como_orderstatus_status') && $this->config->get('module_como_orderstatus_colors_status')) {
        ...
        $this->model_extension_module_como_orderstatus->updateOrderStatusColors($order_status_id, $data);
    }
    ...
    if ($this->config->get('module_como_orderstatus_status') && $this->config->get('module_como_orderstatus_colors_status')) {
        $this->load->model('extension/module/como_orderstatus');
        $this->model_extension_module_como_orderstatus->deleteOrderStatus($order_status_id);
    }
