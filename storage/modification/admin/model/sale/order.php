...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			$cargo_shipping_comment_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_shipment_comment` WHERE order_id = '" . (int)$order_id . "'");
			if ($cargo_shipping_comment_query->num_rows) {
				$cargo_shipping_comment = $cargo_shipping_comment_query->row['shipment_comment'];
			} else {
				$cargo_shipping_comment = '';
			}
            ...
            'payment_method' => (isset($order_query->row['payment_method']) ? $order_query->row['payment_method'] : ''),
				...
				'cargo_shipping_comment'  => $cargo_shipping_comment,
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.order_status_id, o.shipping_city, o.payment_method, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
