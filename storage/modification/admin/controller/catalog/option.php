...
class ControllerCatalogOption extends Controller {
	...
	protected function getList() {
		...
		$this->model_catalog_option->mpOptionStatusAlter();
		$this->load->language('catalog/mpoptionstatus');
		...
		$data['sort_status'] = $this->url->link('catalog/option', 'user_token=' . $this->session->data['user_token'] . '&sort=o.status' . $url, true);
