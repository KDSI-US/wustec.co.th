...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		$data['entry_video_name'] = $this->language->get('entry_video_name');
		...
		foreach ($results as $result) {
			...
			'adminQuickView' => HTTP_CATALOG.'index.php?route=product/category&path=' . $result['category_id'],
		...
		$data['sort_name'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
			...
			$data['sort_top'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=top' . $url, true);
			$data['sort_parent_id'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=parent_id' . $url, true);
			$data['sort_category_id'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=category_id' . $url, true);
			...
			$data['sort_column'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=column' . $url, true);
			$data['sort_description'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=description' . $url, true);
			$data['sort_meta_title'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=meta_title' . $url, true);
			$data['sort_meta_description'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=meta_description' . $url, true);
			$data['sort_meta_keyword'] = $this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=meta_keyword' . $url, true);
