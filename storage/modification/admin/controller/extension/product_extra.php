...
class ControllerExtensionProductExtra extends ControllerCatalogProduct {
	...
	public function __construct($arg){
  	...
  	public function index() {
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_style_code"){
			echo $this->model_extension_product_extra->changeStyleCode((int)$this->request->get['product_id'], $this->request->get['style_code']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_msrp"){
			echo $this->model_extension_product_extra->changeMsrp((int)$this->request->get['product_id'], $this->request->get['msrp']);
			die();
		}
		...
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_special"){
			echo $this->model_extension_product_extra->changeProductSpecialPrice((int)$this->request->get['product_id'], (float)$this->request->get['price'], $this->request->get['customer_group_id']);
			die();
		}
		if(isset($this->request->get['type']) && $this->request->get['type'] == "change_discount"){
			echo $this->model_extension_product_extra->changeProductDiscountPrice((int)$this->request->get['product_id'], (float)$this->request->get['price'], $this->request->get['customer_group_id']);
			die();
		}
	...
	protected function validateSpecialForm(){
  	...
  	protected function getList() {
		...
		if (isset($this->request->get['filter_special_price_customer_group'])) {
			$filter_special_price_customer_group = $this->request->get['filter_special_price_customer_group'];
		} else {
			$filter_special_price_customer_group = NULL;
		}

		if (isset($this->request->get['filter_discount_price_customer_group'])) {
			$filter_discount_price_customer_group = $this->request->get['filter_discount_price_customer_group'];
		} else {
			$filter_discount_price_customer_group = NULL;
		}
		...
		if (isset($this->request->get['filter_style_code'])) {
			$url .= '&filter_style_code=' . urlencode($this->request->get['filter_style_code']);
		}
			

		if (isset($this->request->get['filter_msrp'])) {
			$url .= '&filter_msrp=' . urlencode($this->request->get['filter_msrp']);
		}
		...
		if (isset($this->request->get['filter_special_price_customer_group'])) {
			$url .= '&filter_special_price_customer_group=' . urlencode($this->request->get['filter_special_price_customer_group']);
		}
		if (isset($this->request->get['filter_discount_price_customer_group'])) {
			$url .= '&filter_discount_price_customer_group=' . urlencode($this->request->get['filter_discount_price_customer_group']);
		}
		...
		$filter_data = array(
			...
			'filter_special_price_customer_group'   	=> $filter_special_price_customer_group,
			'filter_discount_price_customer_group'   	=> $filter_discount_price_customer_group,
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'special_price'=>$this->model_extension_product_extra->getMaxSpecialPrice($result['product_id'], $filter_special_price_customer_group),
				'discount_price'=>$this->model_extension_product_extra->getMaxDiscountPrice($result['product_id'], $filter_discount_price_customer_group),
				'tags'	     => $result['tag'],
				'image'      => $image,
		...
		$data['style_code_column'] = $this->language->get('style_code_column');
		$data['style_code_column_switch'] = $this->language->get('style_code_column_switch');
		...
		$data['msrp_column_switch'] = $this->language->get('msrp_column_switch');
		...
		$data['reset_table_order'] = $this->language->get('reset_table_order');
		...
		if (isset($this->request->get['filter_style_code'])) {
			$url .= '&filter_style_code=' . $this->request->get['filter_style_code'];
		}
		...
		$data['filter_special_price_customer_group'] = $filter_special_price_customer_group;
		$data['filter_discount_price_customer_group'] = $filter_discount_price_customer_group;
		...
		$this->template = 'extension/product_list_extra';
