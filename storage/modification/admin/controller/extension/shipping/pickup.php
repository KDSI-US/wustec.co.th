...
class ControllerExtensionShippingPickup extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_pickup_instruction'])) {
			$data['shipping_pickup_instruction'] = $this->request->post['shipping_pickup_instruction'];
		} else {
			$data['shipping_pickup_instruction'] = $this->config->get('shipping_pickup_instruction');
		}

		if (isset($this->request->post['shipping_pickup_instruction_text_color'])) {
			$data['shipping_pickup_instruction_text_color'] = $this->request->post['shipping_pickup_instruction_text_color'];
		} else {
			$data['shipping_pickup_instruction_text_color'] = $this->config->get('shipping_pickup_instruction_text_color');
		}
