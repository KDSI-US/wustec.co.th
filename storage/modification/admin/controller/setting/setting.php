...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_video_gallery_youtube'] = $this->language->get('text_video_gallery_youtube');
		$data['entry_video_gallery_youtube_key'] = $this->language->get('entry_video_gallery_youtube_key');
		...
		if (isset($this->request->post['config_video_gallery_youtube_key'])) {
			$data['config_video_gallery_youtube_key'] = $this->request->post['config_video_gallery_youtube_key'];
		} else {
			$data['config_video_gallery_youtube_key'] = $this->config->get('config_video_gallery_youtube_key');
		}
		...
		if (isset($this->request->post['config_googlemap_embed_html'])) {
			$data['config_googlemap_embed_html'] = $this->request->post['config_googlemap_embed_html'];
		} else {
			$data['config_googlemap_embed_html'] = $this->config->get('config_googlemap_embed_html');
		}

		if (isset($this->request->post['config_contact_details'])) {
			$data['config_contact_details'] = $this->request->post['config_contact_details'];
		} else {
			$data['config_contact_details'] = $this->config->get('config_contact_details');
		}
		...
		if (isset($this->request->post['config_megamenu'])) {
			$data['config_megamenu'] = $this->request->post['config_megamenu'];
		} else {
			$data['config_megamenu'] = $this->config->get('config_megamenu');
		}
		...
		if (isset($this->request->post['config_meta_twitter'])) {
			$data['config_meta_twitter'] = $this->request->post['config_meta_twitter'];
		} else {
			$data['config_meta_twitter'] = $this->config->get('config_meta_twitter');
		}

		if (isset($this->request->post['config_meta_opengraph'])) {
			$data['config_meta_opengraph'] = $this->request->post['config_meta_opengraph'];
		} else {
			$data['config_meta_opengraph'] = $this->config->get('config_meta_opengraph');
		}

		if (isset($this->request->post['config_favicons'])) {
			$data['config_favicons'] = $this->request->post['config_favicons'];
		} else {
			$data['config_favicons'] = $this->config->get('config_favicons');
		}
        ...
        if (isset($this->request->post['config_secure_admin_url'])) {
			$data['config_secure_admin_url'] = $this->request->post['config_secure_admin_url'];
		} else {
			$data['config_secure_admin_url'] = $this->config->get('config_secure_admin_url');
		}
		...
		$data['text_zendesk_key'] = $this->language->get('text_zendesk_key');
		$data['entry_zendesk_key'] = $this->language->get('entry_zendesk_key');
		if (isset($this->request->post['config_zendesk_key'])) {
			$data['config_zendesk_key'] = $this->request->post['config_zendesk_key']; 
		} else {
			$data['config_zendesk_key'] = $this->config->get('config_zendesk_key');
		}
      
  
		$data['tab_sms'] = $this->language->get('tab_sms');    
		$data['text_twilio'] = $this->language->get('text_twilio');
		$data['entry_twilio_sid'] = $this->language->get('entry_twilio_sid');
		$data['entry_twilio_token'] = $this->language->get('entry_twilio_token');
		$data['entry_twilio_number'] = $this->language->get('entry_twilio_number');
		
		if (isset($this->request->post['config_twilio_sid'])) {
			$data['config_twilio_sid'] = $this->request->post['config_twilio_sid']; 
		} else {
			$data['config_twilio_sid'] = $this->config->get('config_twilio_sid');
		}

		if (isset($this->request->post['config_twilio_token'])) {
			$data['config_twilio_token'] = $this->request->post['config_twilio_token']; 
		} else {
			$data['config_twilio_token'] = $this->config->get('config_twilio_token');
		}

		if (isset($this->request->post['config_twilio_number'])) {
			$data['config_twilio_number'] = $this->request->post['config_twilio_number']; 
		} else {
			$data['config_twilio_number'] = $this->config->get('config_twilio_number');
		}
