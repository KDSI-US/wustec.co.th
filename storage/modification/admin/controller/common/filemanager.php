...
class ControllerCommonFileManager extends Controller {
	public function index() {
		...
		if (substr(str_replace('\\', '/', $directory . '/' . $filter_name), 0, strlen(DIR_IMAGE . 'catalog')) == str_replace('\\', '/', DIR_IMAGE . 'catalog')) {
			// Get directories
	...
	public function upload() {
		...
		if (!is_dir($directory) || substr(str_replace('\\', '/', $directory), 0, strlen(DIR_IMAGE . 'catalog')) != str_replace('\\', '/', DIR_IMAGE . 'catalog')) {
	...
	public function delete() {
		...
		foreach ($paths as $path) {
			// Check path exsists
			if ($path == DIR_IMAGE . 'catalog' || substr(str_replace('\\', '/', DIR_IMAGE . $path), 0, strlen(DIR_IMAGE . 'catalog')) != str_replace('\\', '/', DIR_IMAGE . 'catalog')) {
