...
class Document {
	...
	private $scripts = array();
			...
			private $mpgallerymetas = array();
			public function setgalleryMpMeta($content) {
				/*
				$meta['attribute']
				$meta['attribute_value']
				$meta['content']
				*/
				$this->mpgallerymetas[] = $content;
			}
			public function getgalleryMpMeta() {
				return $this->mpgallerymetas;
			}
